...
public class TestExpression {
    ...
    public void test1() throws InstantiationException, IllegalAccessException {
        ...
        Expression expression = new Expression(expressionScript, new Properties(Collections.emptyMap()).groovyClassLoader);
        Event ev = new Event();
        ev.put("value", "a");
        Object o = expression.eval(ev, Collections.singletonMap("formatters", formatters));
