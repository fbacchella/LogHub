...
public class CategoryLegacy {
    ...
    private static final String FQCN = CategoryLegacy.class.getName();
     ...
     */
    protected CategoryLegacy(final LoggerContext context, final String name) {
     ...
     * @param name The name of the Logger.
     */
    protected CategoryLegacy(final String name) {
        this(PrivateManager.getContext(), name);
        System.out.println(name);
    }

    private CategoryLegacy(final org.apache.logging.log4j.core.Logger logger) {
        this.logger = logger;
    }

    public static CategoryLegacy getInstance(final String name) {
    ...
    static Logger getInstance(final LoggerContext context, final String name, final LoggerFactory factory) {
        ...
        logger = new Logger(context, name);
        final Logger prev = loggers.putIfAbsent(name, logger);
        return prev == null ? logger : prev;
    }

    public static CategoryLegacy getInstance(@SuppressWarnings("rawtypes") final Class clazz) {
    ...
    public final CategoryLegacy getParent() {
        ...
        return l == null ? new CategoryLegacy(parent) : l;
    }

    public static CategoryLegacy getRoot() {
