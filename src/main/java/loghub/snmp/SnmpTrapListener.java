...
public class SnmpTrapListener implements CommandResponder {
    ...
    public SnmpTrapListener(ESInjector es){
    ...
    public void processPdu(CommandResponderEvent event) {
        ...
        Enumeration<VariableBinding> vbenum = (Enumeration<VariableBinding>) event.getPDU().getVariableBindings().elements();
